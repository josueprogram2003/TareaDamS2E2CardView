package com.example.tareadams2ecardview;
...
public class MainActivity extends AppCompatActivity {
    RecyclerView rv1;
    String []nombres={"Marcos Paz","Diego Martinez","Carlos Didio","Ana Perez","Laura Matiw","Oscar Martinez","Antonela Lopez","Gustavo Lorenzo"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Creamos un objeto de la clase LinearLayoutManager
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        // de rv1 usamos el setLayout Manager para que pueda mostrar las tarjetas debajo una de la otra
    ...
    public class AdaptadorPersona extends RecyclerView.Adapter<AdaptadorPersona.AdaptadorPersonaHolder> {
        ...
        class AdaptadorPersonaHolder extends RecyclerView.ViewHolder{
            ...
            public AdaptadorPersonaHolder(@NonNull View itemView){
                ...
                tv1 = itemView.findViewById(R.id.tv_edad);
                tv2 = itemView.findViewById(R.id.tv_nombre);
            }

            public void imprimir(int position) {
                iv1.setImageResource(fotos[position]);
                tv1.setText("Edad: "+ edades[position]);
                tv2.setText(nombres[position]);
            }
        }
    }
}